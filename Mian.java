...
public class Alreem_217017659 {
                ...
                while(b!=0){
                    switch(b){
                        ...
                        case 3:
                            ...
                            System.out.println("\n****The rooms that are already exisiting****\n\n");
                            viewRooms(hotal);
                                    ...
                                    //find room, then add to reservation.get(cheak)
                                        ...
                                        if(numRoom!=-1){//found
                                            ...
                                            if(room.isBooked()){
                                                ...
                                                System.out.println("\nThank you for booking "+room.toString());
                                                cu.setCounterRe(1);
                                            }//ends else
                                        }// ends outer if
                                }//ends for loop
   ...
   // this method to add a new room 
    ...
    for(int i=0;i<reservation.size();i++){// go one by one on each index to cheak
        if(reservation.get(i).getCustomer().getID()==customerID){
            System.out.println("\n Welcom back "+String.valueOf(reservation.get(i).getCustomer().getName()));
            return i;//founds
        }
    }
    return -1;// not founds outs indexes
 ...
 //.....................to update room information
    ...
    {
            if (j>-1){//.........if it found then update it
            Scanner input = new Scanner(System.in);
